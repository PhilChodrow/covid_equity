...
For reference, if the rank were the order the results show up in, the average rank of the correct page would be `r mean(school_order_in_bing$rank)` and the median would be `r median(school_order_in_bing$rank)`.
