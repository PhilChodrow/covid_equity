...
Unfortunately, only 24 out of a possible 44 correct urls were found on the first page of Bing results. This means that there needs to be some kind of tweaking to the search or we'll have to grab more than just the first page of results from Bing.
...
This is a dataset containing only the schools that got the correct result in the first page of Bing. On average, the rank of the correct page was 2.292, and the median of the ranks was 2.